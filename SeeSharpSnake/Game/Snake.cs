struct Snake
{
    ...
    // El cuerpo es almacenado como un int que contiene las coordenadas de X, Y y el caracter
    // para el cuerpo de la serpiente.
    // Solo los tipos elementales pueden ser usandos en C# como "fixed", por lo tanto, esto es un `int`.
    ...
    // Estructura del helper que comprime o descomprime lo almacenado en _body.
